...
/**
 * Memoized cell: with stable callbacks (row/col passed explicitly) the cell
 * only re-renders when its own value/selection state actually changes.
 */
export const Cell: React.FC<CellProps> = memo(function Cell({
  value,
  row,
  col,
  isSelected,
